...
import { Search, Bell, Menu, CheckCircle2, AlertCircle, Sparkles } from 'lucide-react';
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
            <button 
                ...
                className={`relative p-3 rounded-2xl border transition-all shadow-sm hover:shadow-md ${
                    showNotifications 
                    ...
                    <div className="max-h-[320px] overflow-y-auto py-2 space-y-1 custom-scrollbar">
                        {notifications.map((n) => (
                            <div key={n.id} className="p-3 mx-1 rounded-2xl hover:bg-stone-50 cursor-pointer flex gap-4 group transition-all relative">
                                {/* Icon Indicator */}
                                <div className={`mt-1 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 border-2 ${
